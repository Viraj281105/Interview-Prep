  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-brand-indigo focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        primary: "border-transparent bg-brand-indigo text-white hover:bg-brand-indigo/80",
        ...
        glass: "border-white/40 bg-white/50 backdrop-blur-sm text-slate-900 dark:bg-slate-800/50 dark:border-slate-700/50 dark:text-slate-100",
        gradient: "border-transparent bg-gradient-accent text-white",
      },
    },
    defaultVariants: {
      variant: "default",
